          ...
          <div className="max-w-md lg:justify-self-end">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <a
                ...
                className="inline-flex items-center justify-center rounded-full bg-white px-6 py-3.5 text-sm font-medium text-brand transition duration-300 hover:bg-white/90"
              >
              ...
              <a
                href="#home"
                className="inline-flex items-center justify-center rounded-full border border-white/20 px-6 py-3.5 text-sm font-medium text-white transition duration-300 hover:border-white/40"
              >
                {t.contact.backToTop}
              </a>
            </div>
