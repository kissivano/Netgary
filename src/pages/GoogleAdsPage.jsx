...
function GoogleAdsPage({ language, setLanguage }) {
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      {/* HERO */}
      <section className="border-b border-border bg-white pt-16 md:pt-20">
          ...
          <div className="relative">
            <div className="overflow-hidden rounded-[24px] border border-border bg-[#fbfbfc]">
              ...
              <div className="p-6 sm:p-8">
                ...
                <div className="mt-9 grid grid-cols-3 gap-3">
                  {["Clicks", "Conversions", "ROAS"].map((item, index) => (
                    ...
                    >
                      ...
                      <div
                        className={`mt-5 rounded-full bg-brand ${
                          index === 0
                            ? "h-1.5 w-[72%]"
                            : index === 1
                              ? "h-1.5 w-[55%]"
                ...
                <div className="mt-5 rounded-[18px] border border-border bg-white p-5">
                  ...
                  <div className="mt-8 flex h-40 items-end gap-2">
                    {[35, 52, 44, 67, 58, 78, 64, 84, 72, 94, 82, 100].map(
                      (height, index) => (
                        <div
                          key={index}
                          className="flex-1 rounded-t-md bg-brand/10"
                          style={{ height: `${height}%` }}
                        >
            ...
            <div className="absolute -top-20 -right-20 -z-10 h-80 w-80 rounded-full bg-[#f3f5fa] blur-3xl" />
          </div>
        </div>
      </section>
      ...
      <section id="google-services" className="bg-zinc-50/60 py-20 lg:py-28">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="mt-14 grid gap-px overflow-hidden rounded-[22px] border border-border bg-border md:grid-cols-2 lg:grid-cols-3">
            {c.services.map((service) => {
              ...
              return (
                <div
                  key={service.title}
                  className="group bg-white p-7 transition duration-300 hover:bg-[#fbfbfc]"
                >
      ...
      <section className="bg-white py-20 lg:py-28">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="rounded-[28px] border border-border bg-[#fbfbfc] px-7 py-12 sm:px-12 lg:px-16 lg:py-16">
            <p className="text-xs font-medium uppercase tracking-[0.2em] text-zinc-400">
              {c.ctaLabel}
            </p>
